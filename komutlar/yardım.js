...
exports.run = async (client, message, args) => {
  ...
  .setDescription(`**Davet Komutları: ➕ \n Ana Menü: 💡** \n Selamlar, bu bot Code My Life'a Aittir `)
...
collector.on('collect', (reaction, user) => {
    ...
    const kobscode = new Discord.MessageEmbed()
      .setColor("BLUE")
 .addField("**Davet Komutları**", `\n**c!**__rütbe-ekle @rol davet__ = **__Rütbe Ekler__** \n**c!**__rütbeler__ = **__Rütbeleri Gösterir 1 Den 10'a Kadar__** \n**c!**__rütbe-sıfırla__ = **__Rütbeyi Sıfırlar.__** \n**c!**__davetleri-sıfırla__ = **__Davetleri Sıfırlar.__** \n**c!**__top__ = **__Lider Tablosunu Gösterir.__** \n**c!**__davetlerim__ = **__Davetlerinizi Gösterir.__** \n**c!**__bonus-ekle__ = **__Bonus Ekler.__** \n**c!**__davet-kanal #kanal__ = **__Davet Kanalını Ayarlar.__** \n**c!**__davet-kanal-sıfırla__ = **__Davet Kanalını Sıfırlar.__**`)
